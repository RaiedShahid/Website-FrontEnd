...
class EditVehicleForm extends Component {
	...
	// 		image.src = personInfo.personImage;
	// 		return;
	// 	}
	...
	handleSubmit = (e) => {
		...
		try {
			axios
				.put(
					`http://localhost:4000/home/vehicle/${this.props.match.params.id}`,
					formData
				)
				.then((res) => {
							...
							<form onSubmit={this.handleSubmit}>
								<div className="form-group">
									<h4 className="text-center mb-3">
										{this.state.personInfo.category} Vehicle Information
									</h4>
									<div className="row">
										<div className="col-lg-6">
											...
											{this.state.errors.carname && (
												<div className="alert alert-danger">
													"VehicleName should be minimum 5 and maximim 25
													letters"
												</div>
											)}
