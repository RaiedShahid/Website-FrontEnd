...
class VehicleLostform extends Component {
	state = {
		personInfo: {
			personImage: "",
			personImage2: "",
	...
	handleSubmit = (e) => {
		...
		try {
			axios
				.post("http://localhost:4000/home/vehicleform", formData)
				.then((res) => {
					window.location = "/";
			...
			<React.Fragment>
				<div className="container mt-3 col-md-8 ">
					<div className=" bg-success text-white py-2 ">
						<h1 className="text-center ">Lost Form</h1>
					</div>
...
export default VehicleLostform;
